...
console.assert(section.start === 2);
console.assert(section.end === 14); // exclusive end of string
console.assert(section.src === 'p= [1, 2][i]')
...
console.assert(section.start === 2);
console.assert(section.end === 10); // exclusive end of string
console.assert(section.src === 'p= [1, 2')
''
```
